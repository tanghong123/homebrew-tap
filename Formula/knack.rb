class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.26.0/knack-0.26.0-aarch64-apple-darwin.tar.gz"
      sha256 "7186fb1c9d050052e4413c0f5a6b5d8907aebde6e64bd70772ef0449d1b77ba8"
    end
  end
