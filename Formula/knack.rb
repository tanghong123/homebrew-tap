class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.4.0/knack-0.4.0-aarch64-apple-darwin.tar.gz"
      sha256 "f6cd260f94a372bf2d68c9e1fd89ba949274fa7d822da47eb3d150d7985b5bf3"
    end
  end
