class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.32.8/knack-0.32.8-aarch64-apple-darwin.tar.gz"
      sha256 "163e5226ee792bedf854bf4d6ec57dec16fd97ee73a95e08c84c917626a7db5a"
    end
  end
