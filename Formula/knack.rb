class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.32.10/knack-0.32.10-aarch64-apple-darwin.tar.gz"
      sha256 "f66e20f224d5a62619da3e6eb4201c3a3edb6ff7335cd86db93205121eb8cf18"
    end
  end
