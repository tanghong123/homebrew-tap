class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.30.5/knack-0.30.5-aarch64-apple-darwin.tar.gz"
      sha256 "8c0adce609f06f61a15008a0f31361a36d40b6a072a8b906a8e83111bdaaf370"
    end
  end
