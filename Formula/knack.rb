class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.29.0/knack-0.29.0-aarch64-apple-darwin.tar.gz"
      sha256 "d5ba73dd627a031644e6dd51bcace6b0a993f129cda43fb7db84f9727df22d59"
    end
  end
