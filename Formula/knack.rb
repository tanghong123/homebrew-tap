class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.18.0/knack-0.18.0-aarch64-apple-darwin.tar.gz"
      sha256 "501f257a73da703877b291c00904e8af830a9385e0369b5e4046dd1226a4175d"
    end
  end
