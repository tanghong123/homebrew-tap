class Knack < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tanghong123/homebrew-tap/releases/download/knack-0.14.0/knack-0.14.0-aarch64-apple-darwin.tar.gz"
      sha256 "b5eccaaf1cf51adab5512295d1b63685c7c29003672a2477bb70f1c3a7db0c14"
    end
  end
