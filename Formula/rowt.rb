class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.5.11.tar.gz"
  sha256 "7019f2240c9fcde960d930a87177d5d550743a11308cdfd29992d7cabb9954e4"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.5.11", shell_output("#{bin}/rowt version")
  end
end
