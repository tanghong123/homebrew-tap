class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.9.tar.gz"
  sha256 "13f311d7a9aef527c3ce59b113a1f1028e721960fea1b7ab0c90d05b1a7a7e43"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.9", shell_output("#{bin}/rowt version")
  end
end
