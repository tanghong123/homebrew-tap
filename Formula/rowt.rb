class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.5.1.tar.gz"
  sha256 "712c73099afa7359e0051f00eec679d3b5d43df548edf706f9ea67076f6ea6ba"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.5.1", shell_output("#{bin}/rowt version")
  end
end
