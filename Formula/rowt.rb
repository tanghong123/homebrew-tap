class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.3.5.tar.gz"
  sha256 "39fdaee34cf850b7f5c7042fa80efbf56419f21c74702c5d1c1b4744215be43d"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.3.5", shell_output("#{bin}/rowt version")
  end
end
