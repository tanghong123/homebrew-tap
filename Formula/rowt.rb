class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.2.0.tar.gz"
  sha256 "6107d8720f1a58ea7df79c02146bded807036f2301c139fb53c726440587e60d"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.2.0", shell_output("#{bin}/rowt version")
  end
end
