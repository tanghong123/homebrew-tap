class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.3.2.tar.gz"
  sha256 "f5e445c1ee7699891dd184a511e95c6c7cad99fd22e6b0ba81c439b0a4235a7e"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.3.2", shell_output("#{bin}/rowt version")
  end
end
