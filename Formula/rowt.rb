class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.1.tar.gz"
  sha256 "35062480ed3683f39826a4dd8d49b6c602c2a1f93cf6578020c5074e34bebf75"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.1", shell_output("#{bin}/rowt version")
  end
end
