class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.8.tar.gz"
  sha256 "61c4de20ae80ec3929735ae0a0a923cbb0f0bb6a9efe32f828c9746870be4b87"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.8", shell_output("#{bin}/rowt version")
  end
end
