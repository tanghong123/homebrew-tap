class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.5.0.tar.gz"
  sha256 "3b283bba11f7c7267b89b318812bb27552c8288acd54a0224494d35287fce6a6"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.5.0", shell_output("#{bin}/rowt version")
  end
end
