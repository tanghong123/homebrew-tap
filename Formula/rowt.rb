class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.0.2.tar.gz"
  sha256 "f62a760be7a3dde3c6b8711fbd9761d5146ead386648e252a6ef4771fe22cd40"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.0.2", shell_output("#{bin}/rowt version")
  end
end
