class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.0.0.tar.gz"
  sha256 "d06b413eee47e28b4b60763cc6365bf9adbf4ea7792eb03f866a5e9f2fa87063"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.0.0", shell_output("#{bin}/rowt version")
  end
end
