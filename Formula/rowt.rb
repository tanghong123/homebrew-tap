class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.7.tar.gz"
  sha256 "f5e371949624865b0a41aaa29ee81b8c729231bcd5dc81d9b277866d1c52c6fd"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.7", shell_output("#{bin}/rowt version")
  end
end
