class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.5.12.tar.gz"
  sha256 "439d2f04394277eb7ee3a375bc65143295ea69579759e749e594f025281ef24a"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.5.12", shell_output("#{bin}/rowt version")
  end
end
