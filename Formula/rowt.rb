class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.1.2.tar.gz"
  sha256 "3f459cfc300b0245ce639bd71cff6ed712302fd64bb4f0ba8fdebc3c9be59a75"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.1.2", shell_output("#{bin}/rowt version")
  end
end
