class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.6.tar.gz"
  sha256 "929ca22c4f1a00b4c6c1b26d660a8f2b121a2a2a5b0cbb96345fd512c077f5a6"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.6", shell_output("#{bin}/rowt version")
  end
end
