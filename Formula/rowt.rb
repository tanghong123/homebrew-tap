class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.5.tar.gz"
  sha256 "e89d105ccbaee108dc852c910340d6b02e3bd047e396904ac5969038ea45f736"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.5", shell_output("#{bin}/rowt version")
  end
end
