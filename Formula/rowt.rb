class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.0.3.tar.gz"
  sha256 "075530ba3b95ac2561415f7ae1b8750577c8461551f83e20ba07fb44350edde5"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.0.3", shell_output("#{bin}/rowt version")
  end
end
