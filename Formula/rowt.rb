class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.4.0.tar.gz"
  sha256 "3b13831185551afc3e7b87cb6d6575bfc2837412facae85443daa166d83121e8"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.4.0", shell_output("#{bin}/rowt version")
  end
end
