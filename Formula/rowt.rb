class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.1.0.tar.gz"
  sha256 "d5971584dfabd416a594c4c25ca3e8bbb863030589b7f490135ac30307f03340"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.1.0", shell_output("#{bin}/rowt version")
  end
end
