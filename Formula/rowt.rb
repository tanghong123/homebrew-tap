class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.4.tar.gz"
  sha256 "a504a40b9c6f488bce5f0c50f9f9286bd34570ac28f57e3090a220f8be952414"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.4", shell_output("#{bin}/rowt version")
  end
end
