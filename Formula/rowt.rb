class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.3.0.tar.gz"
  sha256 "3112e6b2d728795f2fb9a1d12c01232cfa2ae5ea33cd704a60f4adfc718d8d08"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.3.0", shell_output("#{bin}/rowt version")
  end
end
