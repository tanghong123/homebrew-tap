class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.3.8.tar.gz"
  sha256 "88e3dc44764e88cb24b185187ba14d32a581dbed79d3efd2cce430be22c3c43b"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.3.8", shell_output("#{bin}/rowt version")
  end
end
