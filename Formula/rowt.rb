class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.5.14.tar.gz"
  sha256 "2f422b4e17b5ae6a8ca9fa493a4c52ef2c1d4cb17af87b3935e07798aa43e0f1"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.5.14", shell_output("#{bin}/rowt version")
  end
end
