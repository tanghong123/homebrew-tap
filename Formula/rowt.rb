class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v1.3.9.tar.gz"
  sha256 "46068c2de60dbdef03dc368f91156cc4c8fdf8e69321e0bfb960d770b21d0233"
  license "MIT"
  ...
  test do
    assert_match "rowt 1.3.9", shell_output("#{bin}/rowt version")
  end
end
