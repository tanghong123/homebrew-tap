class Rowt < Formula
  ...
  url "https://github.com/tanghong123/rowt/archive/refs/tags/v2.5.15.tar.gz"
  sha256 "8a9017120674871dbae04edc2feb89871407fd70c9f9e473f6ffc1edeb15fc1a"
  license "MIT"
  ...
  test do
    assert_match "rowt 2.5.15", shell_output("#{bin}/rowt version")
  end
end
